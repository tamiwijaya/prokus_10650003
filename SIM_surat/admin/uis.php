...
$pdf = new PDF();
// header tabel 
$header = array('No','Nomor Surat','Tanggal Surat','Tujuan Surat','Pengirim','Perihal Surat');
...
$pdf->AddPage();
$pdf ->text(15,5,'LAPORAN SURAT KELUAR KANTOR KEMENTERIAN AGAMA BANYUMAS PURWOKERTO');
//$pdf ->text(1,5,'INFORMASI DATA MAHASISWA');
