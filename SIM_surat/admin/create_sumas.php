...
<body>
 ...
 <div class="form">
<form action="sumas_created.php" method="post" enctype="multipart/form-data" name="form1" id="form1" class="niceform">
   <fieldset>
...
<dd><input type="text" name="dis" id="dis" value="" size="54"/></dd>
</dl>
